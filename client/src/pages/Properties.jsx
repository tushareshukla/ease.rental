    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          {copied && (
            <p className="fixed top-[23%] right-[5%] z-10 rounded-md bg-gray-100 p-2">
              Link copied!
            </p>
          )}
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <p className="flex items-center mt-6 gap-2 text-gray-600  text-sm">
            ...
            <ul className="text-gray-700 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6">
              ...
              <li className="flex items-center gap-1 whitespace-nowrap ">
                ...
                {listing.pool ? "Swimming Pool" : "No Pool"}
              </li>
              <li className="flex items-center gap-1 whitespace-nowrap ">
                <FaGopuram className="text-lg" />
                {listing.temple ? "Temple" : "No Temple"}
              </li>
            </ul>
